...
declare function extractSchemaFromConnectionString(connectionString: string): string | null;
...
declare function table(tableName: string, columns: Record<string, PgColumnBuilderBase>): drizzle_orm_pg_core.PgTableWithColumns<{
    name: string;
    schema: string;
    columns: {
...
declare const db_extractSchemaFromConnectionString: typeof extractSchemaFromConnectionString;
